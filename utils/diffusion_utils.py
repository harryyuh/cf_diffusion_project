...
class GaussianDiffusion:
    ...
    def ddim_encode_to_xt(
        ...
        end_t = self._clamp_timestep(end_t)
        x = x0
    ...
    def _clamp_timestep(self, t: int) -> int:
        """Map user start_t into [0, timesteps-1] (e.g. start_t=1000 -> 999 when timesteps=1000)."""
        return int(max(0, min(int(t), self.timesteps - 1)))
    ...
    def p_sample_loop_from_xt(
        ...
        """
        start_t = self._clamp_timestep(start_t)
        x = x_t
